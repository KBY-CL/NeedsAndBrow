    ...
    <form action={action} className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          name="hours"
          rows={5}
          defaultValue={JSON.stringify(shop.hours, null, 2)}
          className="font-ui text-charcoal border-gray-light focus:border-gold focus:ring-gold/30 w-full rounded-lg border px-4 py-3 font-mono text-sm focus:ring-1"
        />
        <p className="font-ui text-gray mt-1 text-xs">
          예: {`{"월-금": "10:00 - 20:00", "토": "10:00 - 18:00", "일": "휴무"}`}
        </p>
      </div>
