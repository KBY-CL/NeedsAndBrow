...
export function WriteInquiryForm({ initialPhone }: { initialPhone: string | null }) {
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <div>
        <label htmlFor="password" className="font-ui text-charcoal mb-2 block text-sm font-medium">
          비밀번호 (선택)
        </label>
        <input
          id="password"
