---
name: ui-design
description: 'Needs Ann Brow 프로젝트의 UI 디자인 시스템. 컴포넌트 스타일링, 색상, 타이포그래피, 레이아웃, 반응형 디자인, 애니메이션 작업 시 반드시 참고. 새 컴포넌트 생성, 기존 컴포넌트 수정, 페이지 레이아웃, 모바일 UI, 디자인 토큰, 아이콘, 간격, 그림자 등 시각적 요소를 다루는 모든 작업에서 이 스킬을 사용할 것.'
---

# UI 디자인 시스템

Needs Ann Brow의 모든 시각적 요소는 이 디자인 시스템을 따른다.
